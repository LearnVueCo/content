...
title: A Quick Vue3 Infinite Scrolling Component
snippet: An infinite scrolling component is when content is loaded continuously as someone scrolls down your web app. Learn how to build one in Vue3!
createdDate: 2020/09/01
tags: daily vue,tutorial,ui
slug: a-quick-vue3-infinite-scrolling-component-daily-vue-tips-4
...
![](https://dltqhkoxgn1gx.cloudfront.net/img/posts/a-quick-vue3-infinite-scrolling-component-daily-vue-tips-4-1.png)In this tutorial, we’ll be creating a Vue3 Infinite Scrolling Component using the [Composition API](https://learnvue.co/2020/01/4-vue3-composition-api-tips-you-should-know/). Here’s a sneak peek of what we’ll be building by the end of it. As you can see, it scrolls indefinitely and the scrollbar on the right side of the screen reflects this.

![](https://dltqhkoxgn1gx.cloudfront.net/img/posts/a-quick-vue3-infinite-scrolling-component-daily-vue-tips-4-2.png)<br>
...
There’s a great article by Nick Babich on the[ pros and cons of infinite scrolling/pagination](https://uxplanet.org/ux-infinite-scrolling-vs-pagination-1030d29376f1). I definitely recommend giving it a read, but I’ll sum up the main points.
...
In short, Vue3 replaces the Options API with the Composition API meaning that the code ([lifecycle hooks](https://learnvue.co/2020/03/how-to-use-lifecycle-hooks-in-vue3/), data, etc) is all organized inside a single `setup` method.
...
![](https://dltqhkoxgn1gx.cloudfront.net/img/posts/a-quick-vue3-infinite-scrolling-component-daily-vue-tips-4-3.png)But if we scroll to the bottom, nothing happens. So let’s move on to the exciting part: infinite scrolling!

## Handling Vue3 Infinite Scrolling
...
![](https://dltqhkoxgn1gx.cloudfront.net/img/posts/a-quick-vue3-infinite-scrolling-component-daily-vue-tips-4-4.png)Perfect!
