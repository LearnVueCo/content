...
![](https://dltqhkoxgn1gx.cloudfront.net/img/posts/how-to-make-your-first-vuejs-plugin-1.com/ctAqtayWrioCiv4AMHhdjUDZsNHZaUpqbBsHQStvJrseledeLxD7C1gEOUA3zvorH7H5LNoU11u2jEHuoBbIU-08iRA9bWAfrKzI6wrEG1C_eIYVUPbxIix_k8oWQuYs5LOw3ryY)## Let’s Make It Actually Useful
...
Then, we can use it inside any instance like this…
...
If we did want to pass options, it’s simple. Inside our _src/main.js_ file, all we have to do is add a second argument to our Vue.use method. This argument will be an options object.
