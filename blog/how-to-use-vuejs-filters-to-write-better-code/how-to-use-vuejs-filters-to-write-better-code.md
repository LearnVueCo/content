...
slug: how-to-use-vuejs-filters-to-write-better-code
category: Dev Tips
---
...
Using a Vue filter requires a simple syntax. The format goes _value \| filter_
...
Let’s say we have a list of articles and we want to display the date of every single item. If we used computed properties, this would be extremely hard. We would need to create computed properties for each item – which for most real projects isn’t logistically possible.
